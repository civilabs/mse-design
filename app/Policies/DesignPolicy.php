...
class DesignPolicy
{
     ...
     */
    public function view(User $user, Design $design, string $project_id): Response
    {
        $members = Member::where('project_id', $project_id)->pluck('user_id')->toArray();
        return in_array($user->id, $members)
            ? Response::allow()
     ...
     */
    public function update(User $user, Design $design): Response
    {
     ...
     */
    public function delete(User $user, Design $design): Response
    {
        return $user->id == $design->user_id
            ? Response::allow()
            : Response::deny();
