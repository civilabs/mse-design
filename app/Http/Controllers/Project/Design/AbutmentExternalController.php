...
class AbutmentExternalController extends Controller
{
    /**
    ...
    public function create(string $project_id)
    {
        ...
        return inertia('User/Project/Design/AbutmentExternalStability/Create')->with([
            'project' => $project,
        ]);
    }
    ...
    public function store(Request $request, string $project_id)
    {
        ...
        $design->design_type_id = DesignType::ABUTMENT_EXTERNAL;
        $design->save();

        $abutment_external = new AbutmentExternalStability($validated);
        $abutment_external->project_id = $project_id;
        $abutment_external->design_id = $design->id;
        $abutment_external->save();
