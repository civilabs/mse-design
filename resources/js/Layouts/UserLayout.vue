                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('user.projects.index')" class="nav-link"
                                :class="{ 'active': $page.url === '/user/projects' || $page.url === '/user/projects/create' }">
                            <i class="nav-icon fa-solid fa-list"></i>
                            <p>Projects list</p>
                            </Link>
                        </li>
                        <li class="nav-item" @click="hideSidebar">
                            <Link :href="route('user.projects.map')" class="nav-link"
                                :class="{ 'active': $page.url.startsWith('/user/projects/map') }">
