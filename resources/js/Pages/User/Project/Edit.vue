...
const submit = (id) => {
    form.post(route('user.projects.update', id), {
        onFinish: () => {
            form.reset()
        },
    })
    ...
    if (props.cord[0] && props.cord[1]) {
        ...
        layer = new VectorLayer({
            source: new VectorSource({
                features: [
                    new Feature({
                        geometry: new Point(fromLonLat(props.cord)),
...
<script>
import UserLayout from '@/Layouts/ProjectLayout.vue';
export default {
    layout: UserLayout
}
</script>
...
<template>
    ...
    <h3 class="mb-4 ms-3 pt-4 font-weight-normal">Edit Project</h3>
                ...
                <div class="col-lg-6">
                    <div class="container-fluild form-group">
                        ...
                        <div v-if="project.image">
                            <img id="imageview" height="100px" :src="'/storage/project/image/' + project.image">
                        </div>
                        <div v-else>
